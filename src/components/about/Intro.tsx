  ...
  return (
    <>
      ...
      <div className="r-text-base">
        ...
        하드웨어, 소프트웨어 기술을 학습할 수 있는 기회를 제공합니다. 이를 통해 학생들은 기술적 역량을 키울 뿐만 아니라
        창의적인 문제 해결 능력과 협동심을 배울 수 있습니다. 또한, RCKA는 학생들이 친구들과 기술을 공유하며 팀워크를
        경험하고, 새로운 동기 부여와 경험을 얻을 수 있는 기회를 제공합니다.
      </div>
      <div className="r-text-base">
